...
class MvisLeftWagonInfo(WildModel):
    '''MVIS processed information table'''
    ts = DoubleField(null = True)
    train_id = CharField(null = True)
    ...
    class Meta:
        table_name = "mvis_left_wagon_info"

class MvisRightWagonInfo(WildModel):
    '''MVIS processed information table'''
    ts = DoubleField(null = True)
    train_id = CharField(null = True)
    dpu_id = CharField(null = True)
    ...
    class Meta:
        table_name = "mvis_right_wagon_info"
...
if __name__ == '__main__':
    ...
    psql_db.create_tables([MvisLeftWagonInfo, MvisRightWagonInfo])
